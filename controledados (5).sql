...
--
-- Host: 127.0.0.1
-- Generation Time: 12-Jun-2021 às 18:58
...
INSERT INTO `escola` (`IDESCOLA`, `NOME`, `ENDERECO`, `TELEFONE`) VALUES
(1, 'unasp ec', '18 92930948', 'rua das avores');
...
INSERT INTO `mensalidades` (`RA`, `STATUSFATURA`, `MES`) VALUES
(3, 'paga', 'abril'),
(4, 'não paga', 'abril');
...
--
ALTER TABLE `escola`
  MODIFY `IDESCOLA` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `mensalidades`
  MODIFY `RA` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
